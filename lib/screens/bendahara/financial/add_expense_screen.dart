  ...
  Future<void> _saveExpense() async {
    if (_amountController.text.isEmpty ||
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Nominal, Kategori, dan Keterangan wajib diisi!'),
        ),
      );
      return;
    }
    ...
    try {
      ...
      final Map<String, dynamic> requestBody = {
        ...
        'source':
            _selectedCategory, // Dikirim ke key 'source' sesuai struktur database Laravelmu
        'amount': double.tryParse(cleanAmount) ?? 0,
        'description': _descriptionController.text
            .trim(), // Catatan masuk ke kolom 'description'
      };
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Catatan pengeluaran kas berhasil disimpan!'),
        ),
      );
